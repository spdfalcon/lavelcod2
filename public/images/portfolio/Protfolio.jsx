...
const Portfolio = () => {
    return (
        <div className="w-full h-auto flex flex-col  justify-center items-center md:-translate-y-28 relative">
                ...
                <div className="col-span-12 md:col-span-6 lg:col-span-4 md:flex flex-col shadow-md rounded-2xl hidden">
                    ...
                    <div>
                        <button className="w-full h-12 flex justify-center items-center text-xs text-text-gray">
                             ...
                             مشاهده نمونه طراحی سایت فروشگاهی 
                             </button>
                    </div>
                </div>
            ...
            <button className="w-[73%] md:w-52 px-2 md:py-6 py-3 flex items-center justify-center gap-3 text-sm bg-bg-btn rounded-xl text-white mt-7 mb-9">
                مشاهده ی نمونه کار ها 
                <BsArrowLeft/>
                </button>
        </div>
    );
